...
builder.Services.AddScoped<DbConnection>(sp=> new SqlConnection(builder.Configuration.GetConnectionString("DefaultConnexion")));
builder.Services.AddScoped<RefugeService>();
