...
BEGIN
	BEGIN TRY
		...
		INSERT INTO [dbo].[Benevole] ([Prenom], [Nom], [Tel], [Adresse], [EstResponsable], [FormeFerme], [FormeReptile], [FormeContrat])
		VALUES (@Prenom, @Nom, @Tel, @Adresse, @EstResponsable, @FormeFerme, @FormeReptile, @FormeContrat)
